...
<head>
    ...
    <title>Recuperar contraseña - JUnical</title>
...
<body class="h-full flex items-center justify-center p-4">
    <div class="card w-full max-w-md glass rounded-3xl shadow-2xl shadow-blue-100/80 p-7 sm:p-8">
        ...
        <div class="flex items-center gap-3 mb-5">
            ...
            <div>
                <h1 class="text-lg font-bold text-slate-800">Recuperar contraseña</h1>
                <p class="text-xs text-slate-500">Valida tu cédula y te la restablecemos</p>
            </div>
        </div>
        ...
        <div class="bg-sky-50 border border-sky-200 rounded-xl p-3 mb-5">
            <p class="text-sky-800 text-xs leading-relaxed">
                Ingresa tu número de cédula. Si estás activo en Salomón, restableceremos tu contraseña
                al mismo número de cédula y al ingresar podrás definir una nueva.
            </p>
        </div>
