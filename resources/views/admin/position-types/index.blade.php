    ...
    <div class="anim-fade-up bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
        ...
        <div class="border-b border-slate-100 last:border-0">
            <div class="flex items-center gap-3 px-5 py-3.5 row-hover">
                ...
                <form method="POST" action="{{ route('admin.position-types.destroy', $pt) }}" class="inline"
                      data-confirm-title="¿Eliminar cargo?"
                      data-confirm="Se eliminará el cargo '{{ $pt->name }}'. Esta acción no se puede deshacer.">
                    @csrf @method('DELETE')
